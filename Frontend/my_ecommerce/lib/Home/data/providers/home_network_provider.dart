...
class HomeNetworkProvider extends ApiService {
  Future<Map<String, dynamic>> getDealOfDay() async {
    final Response response = await dio.get(Urls.DEAL_OF_DAY);
  ...
  Future<List<dynamic>> getTopRatedProducts() async {
    final Response response = await dio.get(
      Urls.TOP_RATED,
    );
    return response.data;
  ...
  Future<List<dynamic>> getNewlyAddedProducts() async {
    final Response response = await dio.get(
      Urls.NEWLY_ADDED,
    );
    return response.data;
  ...
  Future<List<dynamic>> getProductsAds() async {
    final Response response = await dio.get(
      Urls.PRODUCTS_ADS,
    );
    return response.data;
