...
class WishlistNetworkProvider extends ApiService {

    Future<List<dynamic>> getWishlist(String token) async {
    ...
    Future<List<dynamic>> addWishlist(String token, String id) async {
    ...
    Future<List<dynamic>> removeWishlist(String token, String id) async {
    final Response response = await dio.post(
      Urls.REMOVE_WISHLIST,
      options: Options(
        headers: {
          'Authorization': 'Bearer $token',
        },
